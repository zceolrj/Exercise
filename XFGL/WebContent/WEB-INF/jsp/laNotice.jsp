...
<link rel="stylesheet" type="text/css" href="../css/laNotice.css">
      ...
      <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            <img src="../images/laNotes1.jpg" alt="">
          ...
          <div class="item">
            <img src="../images/laNotes2.jpg" alt="">
            <div class="carousel-caption">
              ...
            </div>
          </div>
          ...
          <div class="item">
            <img src="../images/laNotes3.jpg" alt="">
            <div class="carousel-caption">
              ...
            </div>
          </div>
